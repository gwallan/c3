...
// Load the test page
page.open("http://127.0.0.1:8086/test/main.html");
page.onInitialized = function() {
  page.injectJs(fs.absolute(".") + '/test/asset/browser-shim.js');
  page.injectJs(fs.absolute(".") + '/test/asset/utility.js');
...
page.onLoadFinished = function(status) {
  var loadTimeout = config.loadTimeout || 5000;
  ...
  var handler = setInterval(function(){
    if (page.evaluate(function() { return window.c3; })){
      page.injectJs(fs.absolute(".") + '/test/spec/' + spec + '.js');
