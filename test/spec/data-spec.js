...
describe('c3 chart data', function () {
    ...
    describe('load json', function () {
        ...
        it('should draw correctly', function () {
            ...
            d3.selectAll('.c3-circles-data1 .c3-circle').each(function (d, i) {
                ...
                expect(+circle.attr('cx')).to.be.closeTo(expectedCx[i], -2);
                expect(+circle.attr('cy')).to.be.closeTo(expectedCy[i], -2);
            });
        });
        ...
        it('should draw correctly', function () {
            ...
            d3.selectAll('.c3-circles-443 .c3-circle').each(function (d, i) {
                var circle = d3.select(this);
                expect(+circle.attr('cx')).to.be.closeTo(expectedCx[443][i], -2);
                expect(+circle.attr('cy')).to.be.closeTo(expectedCy[443][i], -2);
            });
            d3.selectAll('.c3-circles-995 .c3-circle').each(function (d, i) {
                var circle = d3.select(this);
                expect(+circle.attr('cx')).to.be.closeTo(expectedCx[995][i], -2);
                expect(+circle.attr('cy')).to.be.closeTo(expectedCy[995][i], -2);
            });
        });
    ...
    describe('function in data.order', function () {
        ...
        it('should return false in isOrderAsc and isOrderDesc functions', function () {
            expect(chart.internal.isOrderAsc() || chart.internal.isOrderDesc()).to.be.eql(false);
        });
    });
    ...
    describe('data.xs', function () {
        ...
        describe('normal x', function () {
            ...
            it('should have correct number of xs for each', function () {
                expect(Object.keys(chart.internal.data.xs).length).to.be.eql(3);
                expect(chart.internal.data.xs.data1.length).to.be.eql(6);
                expect(chart.internal.data.xs.data2.length).to.be.eql(6);
                expect(chart.internal.data.xs.data3.length).to.be.eql(6);
            });

            it('should have integer index as x', function () {
                for (var i = 0; i < chart.internal.data.xs.data3.length; i++) {
                    expect(chart.internal.data.xs.data1[i]).to.be.eql(i);
                    expect(chart.internal.data.xs.data2[i]).to.be.eql(i);
                    expect(chart.internal.data.xs.data3[i]).to.be.eql(i);
                }
            });
        ...
        describe('timeseries x', function () {
            describe('without xFormat', function () {
                ...
                it('should have correct number of xs', function () {
                    expect(Object.keys(chart.internal.data.xs).length).to.be.eql(2);
                    expect(chart.internal.data.xs.data1.length).to.be.eql(3);
                    expect(chart.internal.data.xs.data2.length).to.be.eql(3);
                });

                it('should have Date object as x', function () {
                    var xs = chart.internal.data.xs;
                    expect(+xs.data1[0]).to.be.eql(+new Date(2013, 0, 1, 0, 0, 0));
                    expect(+xs.data1[1]).to.be.eql(+new Date(2013, 0, 2, 0, 0, 0));
                    expect(+xs.data1[2]).to.be.eql(+new Date(2013, 0, 3, 0, 0, 0));
                    expect(+xs.data2[0]).to.be.eql(+new Date(2013, 0, 1, 0, 0, 0));
                    expect(+xs.data2[1]).to.be.eql(+new Date(2013, 0, 2, 0, 0, 0));
                    expect(+xs.data2[2]).to.be.eql(+new Date(2013, 0, 3, 0, 0, 0));
                });
            });
        ...
        describe('milliseconds timeseries x', function () {
            ...
            describe('as date string', function () {
                ...
                it('should have correct number of xs', function () {
                    expect(Object.keys(chart.internal.data.xs).length).to.be.eql(2);
                    expect(chart.internal.data.xs.data1.length).to.be.eql(2);
                    expect(chart.internal.data.xs.data2.length).to.be.eql(2);
                });

                it('should have Date object as x', function () {
                    var xs = chart.internal.data.xs;
                    expect(+xs.data1[0]).to.be.eql(+new Date(2014, 4, 20, 17, 25, 0, 123));
                    expect(+xs.data1[1]).to.be.eql(+new Date(2014, 4, 20, 17, 30, 0, 345));
                    expect(+xs.data2[0]).to.be.eql(+new Date(2014, 4, 20, 17, 25, 0, 123));
                    expect(+xs.data2[1]).to.be.eql(+new Date(2014, 4, 20, 17, 30, 0, 345));
                });
                ...
                it('should have milliseconds tick format', function () {
                    ...
                    chart.internal.main.selectAll('.c3-axis-x g.tick text').each(function (d, i) {
                        expect(d3.select(this).text()).to.be.eql(expected[i]);
                    });
                });
            ...
            describe('as unixtime number', function () {
                ...
                it('should have Date object as x', function () {
                    var xs = chart.internal.data.xs;
                    expect(+xs.data1[0]).to.be.eql(1417622461123);
                    expect(+xs.data1[1]).to.be.eql(1417622522345);
                    expect(+xs.data2[0]).to.be.eql(1417622461123);
                    expect(+xs.data2[1]).to.be.eql(1417622522345);
                });
            });
    ...
    describe('data.label', function () {
            ...
            it('should locate data labels in correct position', function () {
                ...
                Object.keys(expectedTextY).forEach(function (key) {
                    d3.selectAll('.c3-texts-' + key + ' text.c3-text').each(function (d, i) {
                        ...
                        expect(+text.attr('y')).to.be.closeTo(expectedTextY[key][i], -2);
                        expect(+text.attr('x')).to.be.closeTo(expectedTextX[key][i], -2);
                    });
                });
            });
        ...
        describe('for all targets', function () {
            ...
            it('should have data labels on all data', function () {
                d3.selectAll('.c3-texts-data1 text').each(function (d, i) {
                    expect(d3.select(this).text()).to.be.eql(args.data.columns[0][i + 1] + '');
                });
                d3.selectAll('.c3-texts-data2 text').each(function (d, i) {
                    expect(d3.select(this).text()).to.be.eql(args.data.columns[1][i + 1] + '');
                });
                d3.selectAll('.c3-texts-data3 text').each(function (d, i) {
                    expect(d3.select(this).text()).to.be.eql(args.data.columns[2][i + 1] + '');
                });
            });
            ...
            describe('as true', function () {
                ...
                it('should have data labels on all data', function () {
                    ...
                    d3.selectAll('.c3-texts-data2 text').each(function () {
                        expect(d3.select(this).text()).to.be.eql('');
                    });
        ...
        describe('with small values', function () {
            ...
            it('should have proper y domain', function () {
                ...
                expect(domain[0]).to.be.closeTo(-0.02);
                expect(domain[1]).to.be.closeTo(0.45);
            });
        });
        ...
        describe('with positive values and null', function () {
            ...
            describe('on rotated axis', function () {
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(0, -1);
                    expect(domain[1]).to.be.closeTo(231, -1);
                });
        ...
        describe('with negative values and null', function () {
            ...
            describe('on not rotated axis', function () {
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(-215, -1);
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(-215, -1);
                    expect(domain[1]).to.be.closeTo(25, -1);
                });
            ...
            describe('on rotated axis', function () {
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(-220, -1);
                    expect(domain[1]).to.be.closeTo(0, -1);
                });
        ...
        describe('with positive and negative values and null', function () {
            ...
            describe('on non rotated axis', function () {
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(-243, -1);
                    expect(domain[1]).to.be.closeTo(253, -1);
                });
            ...
            describe('on rotated axis', function () {
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(-254, -1);
                    expect(domain[1]).to.be.closeTo(260, -1);
                });
        ...
        describe('with positive grouped values', function () {
            ...
            describe('on non rotated axis', function () {
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(0, -1);
                    expect(domain[1]).to.be.closeTo(885, -1);
                });
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(-94, -1);
                    expect(domain[1]).to.be.closeTo(884, -1);
                });
            ...
            describe('on rotated axis', function () {
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(0, -1);
                    expect(domain[1]).to.be.closeTo(888, -1);
                });
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(-87, -1);
                    expect(domain[1]).to.be.closeTo(887, -1);
                });
        ...
        describe('with negative grouped values', function () {
            ...
            describe('on non rotated axis', function () {
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(-885, -1);
                    expect(domain[1]).to.be.closeTo(0, -1);
                });
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(-884, -1);
                    expect(domain[1]).to.be.closeTo(94, -1);
                });
            ...
            describe('on rotated axis', function () {
                ...
                it('should have y domain with proper padding', function () {
                    var domain = chart.internal.y.domain();
                    expect(domain[0]).to.be.closeTo(-894, -1);
                    expect(domain[1]).to.be.closeTo(0, -1);
                });
